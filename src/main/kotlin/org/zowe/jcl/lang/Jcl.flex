...
%state WAITING_PARAM_DELIM_OR_EQUALS
...
<WAITING_IF_CONDITION_LOGICAL_VALUE,
 WAITING_IF_CONDITION_VALUE_AFTER_RO,
 WAITING_IF_CONDITION_VALUE_OR_SPACE_AFTER_RO> {IF_VALUE}   { return jclBegin(WAITING_IF_LOPERATOR_OR_DOT, JclTypes.PROPERTY_NAME); }
...
WAITING_IF_CONDITION_VALUE_AFTER_RO> {IF_VALUE_DIGITAL}     { return jclBegin(WAITING_IF_LOPERATOR, JclTypes.PROPERTY_NAME); }
...
<WAITING_SPACE_OR_IF_LOPERATOR> {SPACE}*{TUPLE_END}         { return jclBegin(WAITING_IF_LOPERATOR, JclTypes.IF_CONDITION_END); }
...
<WAITING_IF_OPERATOR,
 WAITING_IF_OPERATOR_OR_DOT,
 WAITING_IF_LOPERATOR,
 WAITING_IF_LOPERATOR_OR_DOT> {TUPLE_END}                    { return jclBegin(WAITING_SPACE_OR_IF_LOPERATOR, JclTypes.IF_CONDITION_END); }
...
<WAITING_TUPLE_PARAM_DELIM_OR_EQUALS> {EQUALS}              { return jclBegin(WAITING_TUPLE_PARAM, JclTypes.PARAM_EQUALS); }
...
<WAITING_PARAM_VALUE> {PARAM_VALUE}                         { return jclBegin(WAITING_PARAM_DELIM_OR_EQUALS, JclTypes.SIMPLE_VALUE); }

<WAITING_PARAM_DELIM_OR_EQUALS> {EQUALS}                    { return jclBegin(WAITING_PARAM_VALUE, JclTypes.PARAM_EQUALS); }

<WAITING_PARAM_DELIM,
 WAITING_PARAM_DELIM_OR_EQUALS,
 WAITING_PARAM,
 WAITING_PARAM_VALUE,
