...
public class JclInstreamLineImpl extends ASTWrapperPsiElement implements JclInstreamLine {

  public JclInstreamLineImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JclVisitor visitor) {
    visitor.visitInstreamLine(this);
  }
