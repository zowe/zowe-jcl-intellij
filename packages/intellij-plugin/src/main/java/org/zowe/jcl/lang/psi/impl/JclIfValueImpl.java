...
public class JclIfValueImpl extends ASTWrapperPsiElement implements JclIfValue {

  public JclIfValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JclVisitor visitor) {
    visitor.visitIfValue(this);
  }
  ...
  public JclIfCondition getIfCondition() {
    return findChildByClass(JclIfCondition.class);
  }
