...
public class JclOperatorFullNameImpl extends ASTWrapperPsiElement implements JclOperatorFullName {

  public JclOperatorFullNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JclVisitor visitor) {
    visitor.visitOperatorFullName(this);
  }
