...
public class JclIfBodyImpl extends ASTWrapperPsiElement implements JclIfBody {

  public JclIfBodyImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public JclIfCondition getIfCondition() {
    return findNotNullChildByClass(JclIfCondition.class);
  }
