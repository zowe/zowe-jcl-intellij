...
public class JclIfConditionImpl extends ASTWrapperPsiElement implements JclIfCondition {

  public JclIfConditionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<JclIfValue> getIfValueList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, JclIfValue.class);
  }
