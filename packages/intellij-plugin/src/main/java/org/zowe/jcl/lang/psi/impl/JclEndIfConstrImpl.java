...
public class JclEndIfConstrImpl extends ASTWrapperPsiElement implements JclEndIfConstr {

  public JclEndIfConstrImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JclVisitor visitor) {
    visitor.visitEndIfConstr(this);
  }
